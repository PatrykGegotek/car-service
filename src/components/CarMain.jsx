...
export default function CarMain() {
    return <>
        <div className="p-20 mb-32 min-h-[680px] relative bg-no-repeat bg-bottom-right">
            ...
            <div className="pb-2 flex font-roboto-flex">
                <button className="bg-blue-600 text-white mr-6 py-3 px-5 rounded-md">Zadzwoń do nas</button>
                <button className="bg-white border-blue-600 text-blue-600 border-2 py-3 px-5 rounded-md">Zadzwoń do nas</button>
            </div>
            <img src={waves} className="absolute right-14 bottom-28" alt="car background"/>
